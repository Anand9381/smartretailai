"""
smoke_test_ml.py - moved from project root to avoid pytest collection conflicts

This script is a convenience smoke-test to generate a sample CSV dataset
and exercise the ML functions. It should not be picked up by pytest.
"""
import os
import csv
